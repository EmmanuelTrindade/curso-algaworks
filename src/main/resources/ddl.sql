...
create table cozinha (id int8 generated by default as identity, nome varchar(255), primary key (id));
...
create table usuario (id int8 generated by default as identity, data_cadastro TIMESTAMP DEFAULT CURRENT_TIMESTAMP not null, email varchar(255) not null, nome varchar(255) not null, senha varchar(255) not null, primary key (id));
